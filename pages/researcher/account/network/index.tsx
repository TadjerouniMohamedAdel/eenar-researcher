...
const ResearcherAccountNetworkPage: React.FC = () => {
    ...
    const { isLoading, data, error } = useGetList<{ groups: Group[]; maxPages: number }>(
        "groups",
        `/groups/all`,
        limit,
        offset,
    ...
    const { mutate: addElement, status: addElementStatus } = useAddElement(
        "groups",
        `/groups/add`,
        limit,
        offset,
    ...
    return (
        <ResearcherAccountLayout>
            ...
            <MultiSectionLayout hasSection={false}>
                {/* <WorkInProgress menu="شبكتي" /> */}

                <div className={classes.filterSection}>
                    <div className={classes.groupedActions}>
                        <TextField variant="outlined" label="العنوان" className={classes.input} />
                    </div>
                ...
                <AnimatePresence exitBeforeEnter>
                    {view === "grid" ? (
                        <motion.div
                            key="card-list"
                            id="scrollableDivResearchs"
                            className={classes.scrollableDivResearchs}
                            variants={animLayout}
                            exit="exit"
                            initial="initial"
                            animate="animate"

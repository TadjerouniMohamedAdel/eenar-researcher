                        ...
                        <div className={classes.lastMessagesItems}>
                            {lastMessages.map((message, index) => (
                                <div
                                    ...
                                    className={`${classes.lastMessage} ${active === index && classes.active}`}
                    ...
                    <div className={classes.discussion}>
                        <div className={classes.senderHeader}>
                            <div className={classes.senderInfo}>
                                ...
                                <h1>
                                    ...
                                    <span className={`${lastMessages[active].active && classes.online}`}>
                                        {lastMessages[active].active ? "متصل" : "غير متصل"}
                                    </span>
                                </h1>
                            </div>
                            <div>
                        ...
                        <div className={classes.messages}>
                            {lastMessages[active].messages.map((message, index) => (
                                <div
                                    className={`${classes.message} ${!message.fromSender && classes.myMessage}`}
                                    key={`message-${index}`}
                                >
                                    {message.fromSender &&
                                        (!lastMessages[active].messages[index - 1] ||
                                            (!lastMessages[active].messages[index - 1].fromSender &&
                                                lastMessages[active].messages[index].fromSender)) && (
                                            <div className={classes.senderImage}>
                                                <img src={lastMessages[active].image} alt="" />
                                            </div>
                                        )}
                                    <div
                                        className={`${classes.messageContent} ${
                                            !message.fromSender && classes.myMessage
                                        }`}
                                    >
                                        {message.message}
                                    </div>
                            ...
                            <FormControl variant="outlined" style={{ width: "80%" }}>
                                <OutlinedInput
                                    ...
                                    endAdornment={
                                        <InputAdornment position="end">
                                            <IconButton>
                                                <FontAwesomeIcon icon={faImage} style={{ color: "#cfcfd9" }} />
                                            </IconButton>
                                        </InputAdornment>
                                    }
                                    aria-describedby="outlined-weight-helper-text"

        ...
        return (
            <div className={classes.formFields}>
                <TextField
                    ...
                    error={Boolean(formik1.errors.firstname)}
                ...
                <TextField
                    ...
                    type="text"
                    onChange={formik1.handleChange}
                    error={Boolean(formik1.errors.lastname)}
                ...
                <TextField
                    ...
                    type="text"
                    onChange={formik1.handleChange}
                    error={Boolean(formik1.errors.center)}
        ...
        return (
            <div className={classes.formFields}>
                <TextField
                    ...
                    error={Boolean(formik2.errors.region)}
                ...
                <TextField
                    ...
                    type="text"
                    onChange={formik2.handleChange}
                    error={Boolean(formik2.errors.city)}
                ...
                <TextField
                    ...
                    type="text"
                    onChange={formik2.handleChange}
                    error={Boolean(formik2.errors.address)}
    ...
    const showStep3 = () => (
        <div className={classes.formFields}>
            <TextField
                ...
                error={Boolean(formik3.errors.job)}
            ...
            <TextField
                ...
                type="text"
                onChange={formik3.handleChange}
                error={Boolean(formik3.errors.email)}
            ...
            <TextField
                ...
                type="password"
                onChange={formik3.handleChange}
                error={Boolean(formik3.errors.password)}
            ...
            <TextField
                ...
                type="password"
                onChange={formik3.handleChange}
                error={Boolean(formik3.errors.retypedPassword)}
